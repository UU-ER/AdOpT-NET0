...
#. **The investment period length**: Here you can specify the length of one investment period (in years) when using
   multiyear analysis with perfect foresight. This is a future feature, for now only single-period analysis is possible.
