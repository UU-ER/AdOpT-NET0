...
Rolling-horizon and multi-period optimization
=============================================
To represent long-term transitions toward net-zero systems, the model supports a multi-period optimization framework
using a rolling-horizon approach. Each investment interval (e.g., decade) is formulated as an independent optimization
