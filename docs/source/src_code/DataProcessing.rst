...
``adopt_net0.core.data_management.handle_input_data.DataHandle`` provides a class to import and manipulate data consistent with
the model.

Data Handle Class
=====================

.. automodule:: adopt_net0.core.data_management.handle_input_data
    :members:
