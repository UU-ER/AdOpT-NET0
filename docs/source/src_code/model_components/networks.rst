...
no subclasses of specific network models. An overview of all networks that are currently available as a template can be found
:ref:`here <network_list>`. A network is defined as the set of all arcs (i.e., connections between nodes) of a
