...
class DacAdsorption(Technology):
    ...
    def fit_performance(self, modelhub: object, component_id: tuple, **kwargs):
        ...
        """
        super(DacAdsorption, self).fit_performance(modelhub, component_id)
        ...
        performance_data_path = (
                files("adopt_net0")
                / "core/database/templates/technology_data/DAC/DAC_adsorption_data/dac_adsorption_performance.txt"
        )
