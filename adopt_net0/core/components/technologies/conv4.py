...
inputs, i.e., :math:`output_{car} \\leq S`. This model is useful for
modelling a technology for which you do not care about the inputs (e.g. nuclear), i.e., you do not
...
class Conv4(Technology):
    ...
    def fit_performance(self, modelhub: object, component_id: tuple, **kwargs):
        ...
        """
        super(Conv4, self).fit_performance(modelhub, component_id)
