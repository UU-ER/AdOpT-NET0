...
from adopt_net0.core.components.technologies.genericTechnologies.fitting_classes import FitGenericTecTypeType1, \
    FitGenericTecTypeType2, FitGenericTecTypeType34
...
class Conv1(Technology):
    ...
    **Constraint declarations:**
    ...
    def fit_performance(self, climate_data: pd.DataFrame, location: dict):
        ...
        """
        super(Conv1, self).fit_performance(climate_data, location)
