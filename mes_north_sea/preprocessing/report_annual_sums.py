...
summary_table_node = pd.concat([production_node/1000000, capacity_factors_node, demand_node/1000000], axis=1)
...
summary_table_country = pd.concat([production_country/1000000, capacity_factors_country, demand_country/1000000], axis=1)
