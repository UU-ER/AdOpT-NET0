...
def create_topology_sample():
    ...
    topology.define_time_horizon(
        year=2001, start_date="01-01 00:00", end_date="01-04 23:00", resolution=1
    )
...
def test_initializer():
    ...
    topology.define_new_technologies(
        "testnode", ["Photovoltaic", "Furnace_NG", "Storage_Battery"]
    )
...
def test_load_technologies():
    ...
    topology = SystemTopology()
    topology.define_time_horizon(
        year=2001, start_date="01-01 00:00", end_date="01-01 00:00", resolution=1
    )
