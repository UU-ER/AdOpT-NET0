...
# Our offshore farm
topology.define_new_technologies('offshore', ['Storage_OceanBattery', 'WindTurbine_Offshore_11000'])
topology.define_new_technologies('onshore', ['PowerPlant_Gas', 'Photovoltaic'])


# Our electricity connection to shore
connection_matrix = dm.create_empty_network_matrix(topology.nodes)
connection_matrix.at['onshore', 'offshore'] = 1
connection_matrix.at['offshore', 'onshore'] = 1
...
topology.define_new_network('electricityDC_uni', distance=distance_matrix, connections=connection_matrix)
...
# Export to Excel
results.write_excel('./cases/wind_meets_gas/results/Results_greenfield')
...
# distance_matrix.at['offshore', 'onshore'] = 80
#
# topology.define_existing_network('electricityDC_bi', size=size_matrix, distance=distance_matrix)
#
# carbon_price = 100
# gas_import_limit = 5000
# gas_price = 50
...
#
# # Export to Excel
# results.write_excel('./cases/wind_meets_gas/results/Results_brownfield')
