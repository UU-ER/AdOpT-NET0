...
topology.define_time_horizon(year=2001,start_date='05-01 00:00', end_date='05-30 '
                                                                          '23:00', resolution=1)
...
from_file = 0
if from_file == 0:
    data.read_climate_data_from_file('offshore', './data/climate_data_offshore.p')
    ...
    lat = 52.2
    lon = 4.4
    data.read_climate_data_from_api('offshore', lon, lat,
                                    save_path='./data/climate_data_offshore.p')
