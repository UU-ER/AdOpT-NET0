...
network_data = read_network_data(topology.nodes, './cases/NorthSea_v2/Networks/NetworkDataElectricity_DC_NoConnection.xlsx', 0)
...
energyhub.solve()
results.write_excel(r'.//ad.geo.uu.nl/Users/StaffUsers/6574114/EhubResults/MES NorthSea/20230609/MES_NS_Benchmark')