...
for stage in scenarios.keys():
    ...
    # THIS IS WHERE WE REALLY START
        ...
        if settings.test == 1:
            ...
            configuration.reporting.save_path = '//ad.geo.uu.nl/Users/StaffUsers/6574114/EhubResults/MES NorthSea/baseline_demand_v4/'
            configuration.reporting.save_summary_path = '//ad.geo.uu.nl/Users/StaffUsers/6574114/EhubResults/MES NorthSea/baseline_demand_v4/'
        ...
        if min_cost is None:
            ...
            max_em = energyhub.model.var_emissions_net.value
        ...
        if max_em_reduction is None:
            ...
            max_em_reduction = energyhub.model.var_emissions_net.value / max_em
