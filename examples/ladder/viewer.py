...
def main():
    ...
    parser.add_argument(
        "result_folder",
        nargs="?",
        help="a single folder to read; every result folder of the rung by default",
    )
    parser.add_argument(
        "--rung",
        required=True,
        help="the rung whose results are read, i.e. the folder next to this script",
    )
    ...
    output = Path(args.output) if args.output else case_dir / "results.html"
