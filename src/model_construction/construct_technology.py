...
def construct_technology_block(b_tec, data, set_t_full, set_t_clustered):
    tec = b_tec.index()
...
#
#
# def add_technology(model_block, energyhub, set_tecsToAdd):
#     r"""
...
#         b_tec = technology.construct_tech_model(b_tec, data , set_t, set_t_clustered)
#         if technology.big_m_transformation_required:
#             b_tec = perform_disjunct_relaxation(b_tec)
#
#         return b_tec
