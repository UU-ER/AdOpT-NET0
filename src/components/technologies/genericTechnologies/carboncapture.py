    ...
    **Constraint declarations:**
    ...
    def fit_technology_performance(self, node_data):
        ...
        if self.capture_type == 'MEA':
            ...
            # In this case, the input ratios correspond to the energy consumption per unit of CO2 entering the MEA (main carrier).
            # Note that eta and omega are the equivalent of alpha and beta in the paper of Weimann et Al. 2022. size_min and size_max are given in tCO2/h
        ...
        # Output bounds
        self.fitted_performance.bounds['output']['CO2captured'] = np.column_stack((np.zeros(shape=(time_steps)),
                                                                np.ones(shape=(time_steps)) *
    ...
    def construct_tech_model(self, b_tec, energyhub):
        ...
        if performance_data['capture_type'] == "MEA":
            b_tec = self.__capture_type_MEA(b_tec)
    ...
    def __capture_type_MEA(self, b_tec):
