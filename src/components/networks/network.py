        ...
        **Arc Block declaration**
        ...
        - Constraint definitions
            ...
            * CAPEX of respective arc. Three different CAPEX models are implemented:
              ...
              .. math::
                CAPEX_{arc} = {\gamma}_4 * distance + {\gamma}_3
    ...
    def __define_capex_arc(self, b_arc, b_netw, node_from, node_to):
        ...
        def calculate_max_capex():
            if self.economics.capex_model == 1:
                ...
                max_capex = b_arc.distance * b_netw.para_capex_gamma4 + b_netw.para_capex_gamma3
            return (0, max_capex)
        ...
        def init_capex(const):
            if self.economics.capex_model == 1:
                ...
                return b_arc.var_capex_aux == b_arc.distance * b_netw.para_capex_gamma4 + b_netw.para_capex_gamma3
