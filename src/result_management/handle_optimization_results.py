...
from .utilities import (calculate_tec_cost, calculate_import_costs, calculate_export_revenues,
                        calculate_violation_cost, calculate_net_emissions_from_tecs, calculate_net_emissions_from_cars,
                        calculate_net_emissions_from_netw, calculate_time_stage)

# TODO add documentation for the results file and saving
...
def write_optimization_results_to_h5(energyhub, time_stamp):
    ...
    if energyhub.solution.solver.termination_condition == 'optimal':
        ...
        with h5py.File(h5_file_path, mode='w') as f:
            ...
            net_emissions_from_cars = calculate_net_emissions_from_cars(energyhub)
            ...
            summary_dict["gap"] = energyhub.solution.problem(0).upper_bound - energyhub.solution.problem(0).lower_bound
            ...
            time_stage = calculate_time_stage(energyhub)
            ...
            # NODES: specific node [g] within: specific technology [g]
...
#TODO: possibly move the calculation of tech inputs and outputs to the utilities file for consistency
