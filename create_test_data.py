...
def create_data_test_data_handle():
    ...
    topology.define_time_horizon(
        year=2001, start_date="01-01 00:00", end_date="12-31 23:00", resolution=1
    )
...
def create_data_model2():
    ...
    topology = SystemTopology()
    topology.define_time_horizon(
        year=2001, start_date="01-01 00:00", end_date="01-02 23:00", resolution=1
    )
...
def create_data_emissionbalance1():
    ...
    topology = SystemTopology()
    topology.define_time_horizon(
        year=2001, start_date="01-01 00:00", end_date="01-01 01:00", resolution=1
    )
...
def create_data_emissionbalance2():
    ...
    topology = SystemTopology()
    topology.define_time_horizon(
        year=2001, start_date="01-01 00:00", end_date="01-04 01:00", resolution=1
    )
    topology.define_carriers(["electricity", "heat", "gas", "hydrogen"])
    topology.define_nodes(["test_node1"])
    topology.define_new_technologies(
        "test_node1", ["Storage_Battery", "Photovoltaic", "testCONV1_1"]
    )
    ...
    for j in CONV_Type:
        for i in perf_function_type:
            if (j == 4) and i == 3:
                ...
                data_save_path = (
                    "./src/test/test_data/technology_CONV"
                    + str(j)
                    + "_"
                    + str(i)
                    + ".p"
                ...
                topology.define_time_horizon(
                    ...
                    end_date="01-01 01:00",
                    resolution=1,
                )
                topology.define_carriers(["electricity", "heat", "gas", "hydrogen"])
                topology.define_nodes(["test_node1"])
                topology.define_new_technologies(
                    "test_node1", ["testCONV" + str(j) + "_" + str(i)]
                )
...
def create_data_technologySTOR():
    ...
    topology.define_nodes(["test_node1"])
    topology.define_new_technologies(
        "test_node1", ["TestWindTurbine_Onshore_1500", "testSTOR"]
    )
    ...
    climate_data_path = "./src/test/climate_data_test.p"
    data.read_climate_data_from_file("test_node1", climate_data_path)
    data.node_data["test_node1"].data["climate_data"]["ws10"].iloc[0] = 15
    data.node_data["test_node1"].data["climate_data"]["ws10"].iloc[1] = 0
...
def create_data_network():
    ...
    connection.at["test_node2", "test_node1"] = 1
    topology.define_new_network(
        "hydrogenTest", distance=distance, connections=connection
    )
...
def create_data_technology_dynamics():
    ...
    for j in CONV_Type:
        for i in perf_function_type:
            data_save_path = (
                "./src/test/test_data/technology_dynamics_CONV"
                + str(j)
                + "_"
                + str(i)
                + ".p"
...
def create_data_addtechnology():
    ...
    connection.at["test_node2", "test_node1"] = 1
    topology.define_new_network(
        "electricitySimple", distance=distance, connections=connection
    )
...
def create_data_time_algorithms():
    ...
    topology = SystemTopology()
    topology.define_time_horizon(
        year=2001, start_date="01-01 00:00", end_date="12-03 23:00", resolution=1
    )
...
def create_data_optimization_types():
    ...
    topology.define_nodes(["test_node1"])
    topology.define_new_technologies(
        "test_node1", ["Photovoltaic", "GasTurbine_simple"]
    )
    ...
    data.technology_data["test_node1"]["Photovoltaic"].economics.capex_data[
        "unit_capex"
    ] = 200
    data.technology_data["test_node1"]["GasTurbine_simple"].economics.capex_data[
        "unit_capex"
    ] = 10
    data.save(data_save_path)
...
def create_data_existing_networks():
    ...
    topology3.define_existing_network(
        "electricityTest", size=size_initial, distance=distance
    )
...
def create_test_data_dac():
    topology = SystemTopology()
    topology.define_time_horizon(
        year=2001, start_date="01-01 00:00", end_date="01-05 23:00", resolution=1
    )
    topology.define_carriers(["electricity", "heat", "CO2"])
    topology.define_nodes(["test_node1"])
    topology.define_new_technologies(
        "test_node1", ["DAC_Adsorption", "Storage_CO2", "Photovoltaic"]
    )
...
def create_data_technologyOpen_Hydro():
    ...
    topology.define_nodes(["test_node1"])
    topology.define_new_technologies(
        "test_node1", ["TestWindTurbine_Onshore_1500", "TestPumpedHydro_Open"]
    )
    ...
    topology.define_new_technologies(
        "test_node1",
        ["TestWindTurbine_Onshore_1500", "TestPumpedHydro_Open_max_discharge"],
    )
    ...
    climate_data_path = "./src/test/climate_data_test.p"
    data.read_climate_data_from_file("test_node1", climate_data_path)
    data.read_hydro_maximum_discharge(
        "test_node1",
        "TestPumpedHydro_Open_max_discharge",
        np.ones(len(data.topology.timesteps)) * 0,
    )
    data.read_hydro_natural_inflow(
        "test_node1", "TestPumpedHydro_Open_max_discharge", inflow
    )
    data.node_data["test_node1"].data["climate_data"]["ws10"].iloc[0] = 15
    data.node_data["test_node1"].data["climate_data"]["ws10"].iloc[1] = 0
...
def create_data_carbon_subsidy():
    ...
    topology = SystemTopology()
    topology.define_time_horizon(
        year=2001, start_date="01-01 00:00", end_date="01-02 00:00", resolution=1
    )
    topology.define_carriers(["electricity", "heat", "CO2"])
    topology.define_nodes(["test_node1"])
    topology.define_new_technologies("test_node1", ["DAC_Adsorption", "Storage_CO2"])
